  ...
  return (
    <section id="inicio" ref={ref} className="relative min-h-[100dvh] overflow-hidden bg-ink">
      ...
      <motion.div style={{ y }} className="absolute inset-0 z-0">
        <Image src="/fundo.png" alt="" fill priority sizes="100vw" className="object-cover object-[center_60%]" />
      </motion.div>
      ...
      <motion.div style={{ y }} className="absolute inset-0 z-20">
        <Image src="/dj.png" alt="DJ no palco" fill priority sizes="100vw" className="object-cover object-[center_60%]" />
      </motion.div>
